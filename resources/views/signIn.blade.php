...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
  <div class="max-w-md w-full space-y-8">
    <div>
      <img class="mx-auto h-12 w-auto" src="{{ asset('img/logo_blue.svg') }}" alt="notindeed">
    ...
    {{ csrf_field() }}
      ...
      <div class="rounded-md shadow-sm space-y-6">
        ...
        <div>
          ...
          <input id="confirm-email" name="confirm-email" type="confirm-email" autocomplete="current-confirm-email" required class="appearance-none rounded relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Confirm email">
        </div>
        <div>
        ...
        <div>
          ...
          <input id="confirm-password" name="confirm-password" type="confirm-password" autocomplete="confirm-password" required class="appearance-none rounded relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Confirm password">
        </div>
      </div>
